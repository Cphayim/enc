...
export const isFunction = (o: unknown): o is (...args: never) => unknown =>
  getType(o) === 'Function'

export const isAsyncFunction = (o: unknown): o is (...args: never) => Promise<unknown> =>
  getType(o) === 'AsyncFunction'
...
export const isNone = isUndefinedOrNull
